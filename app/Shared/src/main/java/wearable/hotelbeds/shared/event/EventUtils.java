...
public class EventUtils {
    ...
    private static ArrayList<EventInfoBean> generateDummy() {
        ...
        try {
            ...
            events.add(new EventInfoBean("Id1", "THack @ Hamburg travel hackathon", DATE_FORMATER_HOUR.parse("16/10/2015 18:00"), DATE_FORMATER_HOUR.parse("18/10/2015 20:00"), new BigDecimal("19.90"), image, "Short description combine with start date"));
            ...
            events.add(new EventInfoBean("Id2", "openDeck | Oktoberfest", DATE_FORMATER_HOUR.parse("14/10/2015 18:30"), DATE_FORMATER_HOUR.parse("14/10/2015 21:00"), new BigDecimal("23.99"), image, "short descaj leia"));
            ...
            events.add(new EventInfoBean("Id3", "Sunset Booze Cruise/Boat Party Magaluf 2016", DATE_FORMATER_HOUR.parse("16/04/2016 16:30"), DATE_FORMATER_HOUR.parse("16/04/2016 21:30"), new BigDecimal("90.00"), image, "shoreja eifajenv"));
